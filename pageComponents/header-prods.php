...
<body xen="body" class="bg-primary">
    ...
    <header class="flx flx-rw flx-stretch glass thick-glass prods">
        <div id="org-id" class="flx flx-rw">
            <span id="org-logo" class="bg-image-hold"></span>
            <span id="org-name" class="txt-off-white">VULUE</span>
        </div>
        <div><button id="menu-open-btn" class="btn bg-trans flx"><span class="mtf-icn"></span><span class="txt-white">MIRROR<br>TRADING<br>FUNDS</span></button></div>
        <button class="brdls bg-trans txt-white" id="prods-back-btn"><i class="fa fa-arrow-left fa-lg"></i></button>
    </header>